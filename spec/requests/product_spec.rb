...
RSpec.describe 'Products', type: :request do
  ...
  context 'Post requests for product' do
    ...
    it 'update method' do
      product = Product.create!(name: 'Testing', description: 'This is a testing description', assistants: 5,
                                owner_id: user.id)
      product_edit = { name: 'testing', description: 'This is a test description to test', assistants: 5,
                       owner_id: user.id }
